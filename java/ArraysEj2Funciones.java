...
public class ArraysEj2Funciones {
	...
	public static void main(String[] args) {
		...
		if(pos==-1) {
			...
			System.out.println(v+ " esto en la posicion "+pos);
		}
	}
	
	/**
	 * Funcion que rellena un array con valores pedidos por teclado
	...
	/**
	 * funcion que busca el valor x en el array miArray y devuelve su posicion
	 * @param x : valor buscado
	 * @param miArray : array donde se busca x
	 * @return -1 si no encuentra el valor y la posicion de x dentro del array si lo encuentra
	 */
